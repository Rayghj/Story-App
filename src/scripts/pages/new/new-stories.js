...
export default class NewStories {
    #presenter;
    #form;
    #camera;
    #isCameraOpen = false;
        ...
        <div class="new-story__header">
          <div class="container">
            ...
            <p class="new-story__header__description">
              Silahkan lengkapi formulir ini untuk berbagi cerita anda.
            </p>
          </div>
        </div>
      </section>
        ...
        <div class="new-form__container">
          <form id="new-form" class="new-form">
            ...
            <div class="form-control">
              <label for="description-input" class="new-form__description__title">Deskripsi <i class="fa-solid fa-pencil"></i></label>
  
              <div class="new-form__description__container">
                <textarea
                  id="description-input"
                  name="description"
                  placeholder="Buat/bagikan cerita anda"
                ></textarea>
              </div>
            </div>
            <div class="form-control">
              <label for="documentations-input" class="new-form__documentations__title">Dokumentasi <i class="fa-solid fa-folder-tree"></i></label>
              ...
              <div class="new-form__documentations__container">
                <div class="new-form__documentations__buttons">
                  <button id="documentations-input-button" class="btn btn-outline" type="button">
                    Ambil dari file <i class="fa-solid fa-folder-open"></i>
                  </button>
                  <input
                  ...
                  <button id="open-documentations-camera-button" class="btn btn-outline" type="button">
                    Buka Kamera <i class="fa-solid fa-camera"></i>
                  </button>
                </div>
            ...
            <div class="form-control">
              <div class="new-form__location__title">Lokasi <i class="fa-solid fa-map-location-dot"></i></div>
            ...
            <div class="form-buttons">
              ...
              <span id="cancel-button-container">
    ...
    #setupForm() {
        ...
        this.#form.addEventListener('submit', async (event) => {
            ...
            await this.#presenter.postNewStories(data);
        });

        document
            .getElementById('documentations-input')
            .addEventListener('change', async (event) => {
                const insertingPicturesPromises = Object.values(
                    event.target.files
                ).map(async (file) => {
        ...
        document
            ...
            .addEventListener('click', async (event) => {
                ...
                event.currentTarget.textContent = 'Pakai Kamera';
                this.#camera.stop();
            });
    }
        ...
        document
            ...
            .forEach((button) =>
                button.addEventListener('click', (event) => {
                    const pictureId =
                        event.currentTarget.dataset.deletepictureid;

                    const deleted = this.#removePicture(pictureId);
                    if (!deleted) {
                        console.log(
                            `Picture with id ${pictureId} was not found`
                        );
                    }
